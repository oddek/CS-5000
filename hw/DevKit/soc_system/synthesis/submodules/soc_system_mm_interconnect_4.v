...
module soc_system_mm_interconnect_4 (
	...
	wire   [4:0] mm_bridge_0_m0_limiter_cmd_src_channel;                            // mm_bridge_0_m0_limiter:cmd_src_channel -> limiter_pipeline:in_channel
	...
	wire   [4:0] limiter_pipeline_001_source0_channel;                              // limiter_pipeline_001:out_channel -> mm_bridge_0_m0_limiter:rsp_sink_channel
	...
	wire   [4:0] agent_pipeline_002_source0_channel;                                // agent_pipeline_002:out_channel -> ILC_avalon_slave_agent:cp_channel
	...
	wire         agent_pipeline_004_source0_valid;                                  // agent_pipeline_004:out_valid -> button_pio_s1_agent:cp_valid
	wire  [91:0] agent_pipeline_004_source0_data;                                   // agent_pipeline_004:out_data -> button_pio_s1_agent:cp_data
	wire         agent_pipeline_004_source0_ready;                                  // button_pio_s1_agent:cp_ready -> agent_pipeline_004:out_ready
	wire   [4:0] agent_pipeline_004_source0_channel;                                // agent_pipeline_004:out_channel -> button_pio_s1_agent:cp_channel
	wire         agent_pipeline_004_source0_startofpacket;                          // agent_pipeline_004:out_startofpacket -> button_pio_s1_agent:cp_startofpacket
	wire         agent_pipeline_004_source0_endofpacket;                            // agent_pipeline_004:out_endofpacket -> button_pio_s1_agent:cp_endofpacket
	wire         button_pio_s1_agent_rp_valid;                                      // button_pio_s1_agent:rp_valid -> agent_pipeline_005:in_valid
	wire  [91:0] button_pio_s1_agent_rp_data;                                       // button_pio_s1_agent:rp_data -> agent_pipeline_005:in_data
	wire         button_pio_s1_agent_rp_ready;                                      // agent_pipeline_005:in_ready -> button_pio_s1_agent:rp_ready
	wire         button_pio_s1_agent_rp_startofpacket;                              // button_pio_s1_agent:rp_startofpacket -> agent_pipeline_005:in_startofpacket
	wire         button_pio_s1_agent_rp_endofpacket;                                // button_pio_s1_agent:rp_endofpacket -> agent_pipeline_005:in_endofpacket
	...
	wire  [91:0] agent_pipeline_006_source0_data;                                   // agent_pipeline_006:out_data -> dipsw_pio_s1_agent:cp_data
	wire         agent_pipeline_006_source0_ready;                                  // dipsw_pio_s1_agent:cp_ready -> agent_pipeline_006:out_ready
	wire   [4:0] agent_pipeline_006_source0_channel;                                // agent_pipeline_006:out_channel -> dipsw_pio_s1_agent:cp_channel
	...
	wire  [91:0] dipsw_pio_s1_agent_rp_data;                                        // dipsw_pio_s1_agent:rp_data -> agent_pipeline_007:in_data
	...
	wire  [91:0] agent_pipeline_008_source0_data;                                   // agent_pipeline_008:out_data -> led_pio_s1_agent:cp_data
	wire         agent_pipeline_008_source0_ready;                                  // led_pio_s1_agent:cp_ready -> agent_pipeline_008:out_ready
	wire   [4:0] agent_pipeline_008_source0_channel;                                // agent_pipeline_008:out_channel -> led_pio_s1_agent:cp_channel
	...
	wire  [91:0] led_pio_s1_agent_rp_data;                                          // led_pio_s1_agent:rp_data -> agent_pipeline_009:in_data
	...
	wire  [91:0] rsp_demux_src0_data;                                               // rsp_demux:src0_data -> mux_pipeline_005:in_data
	...
	wire  [91:0] mux_pipeline_005_source0_data;                                     // mux_pipeline_005:out_data -> rsp_mux:sink0_data
	...
	wire  [91:0] rsp_demux_001_src0_data;                                           // rsp_demux_001:src0_data -> mux_pipeline_006:in_data
	...
	wire  [91:0] mux_pipeline_006_source0_data;                                     // mux_pipeline_006:out_data -> rsp_mux:sink1_data
	...
	wire  [91:0] rsp_demux_002_src0_data;                                           // rsp_demux_002:src0_data -> mux_pipeline_007:in_data
	...
	wire  [91:0] mux_pipeline_007_source0_data;                                     // mux_pipeline_007:out_data -> rsp_mux:sink2_data
	...
	wire  [91:0] rsp_demux_003_src0_data;                                           // rsp_demux_003:src0_data -> mux_pipeline_008:in_data
	...
	wire  [91:0] mux_pipeline_008_source0_data;                                     // mux_pipeline_008:out_data -> rsp_mux:sink3_data
	...
	wire  [91:0] rsp_demux_004_src0_data;                                           // rsp_demux_004:src0_data -> mux_pipeline_009:in_data
	...
	wire  [91:0] mux_pipeline_009_source0_data;                                     // mux_pipeline_009:out_data -> rsp_mux:sink4_data
	...
	soc_system_mm_interconnect_4_router_001 router_004 (
	...
	soc_system_mm_interconnect_4_router_001 router_005 (
